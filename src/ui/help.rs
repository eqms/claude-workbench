...
pub fn render(f: &mut Frame) {
    ...
    let text = vec![
        ...
        "  Ctrl+S          : Start Selection Mode",
        "",
        "Terminal Selection Mode (Ctrl+S):",
        "  Start selection mode in any terminal pane",
        "  to copy output to Claude as a code block.",
        "",
        "  j/Down     : Extend selection down",
        "  k/Up       : Shrink selection up",
        "  Shift+Down : Extend selection by 5 lines",
        "  Shift+Up   : Shrink selection by 5 lines",
        "  g          : Jump to start of buffer",
        "  G          : Jump to end of buffer",
        "  Enter / y  : Copy selection to Claude",
        "  Esc        : Cancel selection",
        "",
        "  The copied text is wrapped in a markdown",
        "  code block and sent to the Claude pane.",
        "",
        "Drag & Drop:",
